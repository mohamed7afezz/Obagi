                                ...
                                <>
                                    <div className="col-12 col-md-6 d-lg-none">
                                        <div className={trendingStyles.cardWrapper}>
                                            ...
                                            {item.relationships.field_trending_card_image ? <div className={trendingStyles.image}><Img fluid={item.relationships.field_trending_card_image.localFile.childImageSharp.fluid} /></div> : ''}
                                    ...
                                    <div className="col-lg-4 d-none d-lg-block">
                                        <div className={trendingStyles.cardWrapper}>
                                            ...
                                            {item.field_trending_card_link ? <div className={trendingStyles.linkSection}><Link to={item.field_trending_card_link.uri} className={trendingStyles.link}>Explore</Link></div> : ''}
                                            {item.field_trending_card_title ? <div dangerouslySetInnerHTML={{ __html: item.field_trending_card_title.processed }} className={trendingStyles.title}></div> : ''}
                                            </div>
                                        </div>
                                    </div>

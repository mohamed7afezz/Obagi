...
import * as trendingStyles from '../assets/scss/components/trending.module.scss'
          ...
          return <>
            <div className="col-12 col-md-6 d-lg-none">
              <div className={index == 0 || index == 1? trendingStyles.cardWrapper : trendingStyles.cardWrapper  +" " + trendingStyles.lastCardWrappers}>
                ...
                {item.relationships.field_trending_card_image ? (item.relationships.field_trending_card_image.localFile? <div className={trendingStyles.image}><GatsbyImage
                  image={item.relationships.field_trending_card_image.localFile.childImageSharp.gatsbyImageData}
                  alt="img" /></div> : '') : ''}
...
export const fragment = graphql`fragment paragraphTrending on paragraph__trending {
  id
  relationships {
    field_trending_card {

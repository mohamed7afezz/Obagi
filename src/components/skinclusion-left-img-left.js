...
<div className={["container-fluid"].join(" ")}>
  <div className={["row",skinClusionStyle.aligncenter].join(" ")}>
   ...
   <div className={["col-lg-5 offset-lg-1",skinClusionStyle.boxCon].join(" ")}>
        ...
        <GatsbyImage
          image={node.relationships.field_skinclusion_left_img.localFile.childImageSharp.gatsbyImageData}
          alt="img" />:"":"":""}
...
export const fragment = graphql`fragment paragraphSkinClusionLeftImgLeft on paragraph__skin_clusion_img_text {
  id

        ...
        <div className={aboveHeader.wrapper} id="notification">
            <div className="container-fluid">
                <div className="row">
                    ...
                    <div className={aboveHeader.text}><p>Obagi Members Enjoy Complimentary Shipping on Orders of $125 or More! <Link to="/my-account">Sign In</Link> or <Link to="/registration">Register Today</Link></p></div>

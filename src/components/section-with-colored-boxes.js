...
const SectionWithColoredBoxes = ({ node }) => {
  ...
  if(node.field_image_is_right === null || node.field_image_is_right === "false") {
    isImageRight = false;
  } else {
    isImageRight = true;
  }

   if(node.field_not_homepage === null || node.field_not_homepage === "false") {
    notHomepage = false;
  } else {
    notHomepage = true;
  }

  console.log("colored", isImageRight, notHomepage)
  return (
    <div className={(notHomepage == true && isImageRight == true)? coloredBoxesStyle.notHome + " container-fluid " + coloredBoxesStyle.imageRight : (isImageRight == false && notHomepage == true)? "container-fluid " + coloredBoxesStyle.notHome : "container-fluid"} id="colored-boxes">
      <div className={["row", coloredBoxesStyle.bigSection].join(" ")}>
        <div className={notHomepage == false? "col-10 col-lg-5 "+ coloredBoxesStyle.colLeftPadding + " " + coloredBoxesStyle.firstSection : "col-12 col-lg-5 "+ coloredBoxesStyle.colLeftPadding + " " + coloredBoxesStyle.colRightPadding + " " + coloredBoxesStyle.firstSection}>
        ...
        <div className={notHomepage == false? "col-9 offset-2 col-lg-7 offset-lg-0 " + coloredBoxesStyle.colRightPadding : "col-12 col-lg-6 offset-lg-0"}>

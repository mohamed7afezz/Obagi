                                            ...
                                            {node.relationships.field_form_video ?
                                                <>
                                                    ...
                                                    {node.relationships &&
                                                        ...
                                                        <GatsbyImage
                                                            image={node.relationships.field_form_video[0].relationships.field_video_poster.localFile.childImageSharp.gatsbyImageData}
                                                            alt="img"
                                                            className={[ImgForm.videoimg, "videoposterimg"].join(" ")} />
                                                        : ""}
                                ...
                                <div className="col-lg-10 pl-0">
                                    <div className={ImgForm.imgWrapper}>
                                        {node.relationships &&
                                            ...
                                            <GatsbyImage
                                                image={node.relationships.field_form_left_image.localFile.childImageSharp.gatsbyImageData} />
                                        ...
                                        {node.relationships &&
                                            ...
                                            <div className={ImgForm.overlayImg}>
                                                <GatsbyImage
                                                    image={node.relationships.field_form_overlay_img.localFile.childImageSharp.gatsbyImageData} />
                                            </div>
                                            : ""}
                                    </div>
                                </div>

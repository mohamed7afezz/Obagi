...
const Showbag = ({ node, value, children }) => {
          ...
          <div class="modal-dialog modal-data mr-0 " role="document">
            <div class="modal-content">
              <div class="modal-header">
                ...
                >
                  ...
                  >
                    ...
                    <button class={ShowBagStyle.viewcart}>
                      View Full Cart
                    </button>
                  </div>
                  <button
              ...
              <div class="modal-body ">
                <div
                  className={["row", ShowBagStyle.selectedproductsCard].join(
                    " "
                  )}
                >
                  <div className={"col-4"}>
                  ...
                  <div className={["col-8", Showbag.removepadding].join(" ")}>
                    ...
                    >
                      ...
                      <p className={[ShowBagStyle.Price, "col-2"].join(" ")}>
                        $8.00
                      </p>
                    </div>
                  </div>

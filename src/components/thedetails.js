        ...
        <div className={"row"}>
            <div className={["col-12", "col-lg-4", "offset-lg-1"].join(" ")}>
                <div className={ detailsStyles.detail}>
                    ...
                    <a className={detailsStyles.expand} data-toggle="collapse" href="#multiCollapseExample1" role="button" aria-expanded="false" aria-controls="multiCollapseExample1"><img alt="" src={plus}/> Read More</a>
                ...
                <h1>Safe</h1>
                    ...
                    Free of Sulfates SLS and SLES, parabens, formaldehydes, formaldehyde-releasing agents, phthalates, mineral oil, retinyl palmitate, oxybenzone, coal tar, hydroquinone, triclosan, triclocarban, and contains less than one percent of synthetic fragrances…
                     ...
                     <a className={detailsStyles.expand} data-toggle="collapse" href="#multiCollapseExample2" role="button" aria-expanded="false" aria-controls="multiCollapseExample2"><img alt="" src={plus}/> Full List</a>

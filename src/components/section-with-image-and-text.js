    ...
    <div className={["container-fluid SectionWithImageAndText"].join(" ")}>
      <div className={["row align-items-center", imageAndText.section, imageAndText.rowPadding].join(" ")}>
        ...
        <div className="col-8 offset-2 col-md-4 col-lg-2 offset-lg-1 d-lg-none">
          <div className={[imageAndText.linkSection].join(" ")}><Link to={node.field_text_button.uri.replace('internal:', '')} className={["button-link", imageAndText.link].join(" ")}>{node.field_text_button.title}</Link></div>
        </div>

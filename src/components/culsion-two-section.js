...
const CulsionFlexTwoSections = ({ node }) => {
  console.log('hassan',node)
    return (
      ...
      <div className="mt-auto">  <Img className={[twoSection.culsionImages,"col-8"].join(" ")} fluid={item.relationships.field_clusion_image.localFile.childImageSharp.fluid}/> </div>
      : <div className="mt-auto"> <Img className={twoSection.culsionImages,twoSection.m80} fluid={item.relationships.field_clusion_image.localFile.childImageSharp.fluid}/> </div>
      :"":""}

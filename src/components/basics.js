        ...
        <div>
          {node.relationships && node.relationships.field_basics_product_card
            ? node.relationships.field_basics_product_card.map(
              (item, index) => {
                return item.field_untouchable_fields === false ?
                  (
                                  ...
                                  {cardsProducts[index].map((prod, ind, array) => (
                                    ...
                                    <ProductCard
                                      ...
                                      productimage={prod.relationships &&
                                        ...
                                        prod.relationships.field_medical_image[0].localFile.childImageSharp ? prod.relationships.field_medical_image[0].localFile.childImageSharp.gatsbyImageData
                                        :
                                        prod.relationships &&
                                          ...
                                          prod.relationships.field_clinical_image[0].localFile.childImageSharp ? prod.relationships.field_clinical_image[0].localFile.childImageSharp.gatsbyImageData
                                          : ""}
                                    />
...
export const fragment = graphql`fragment paragraphBasics on paragraph__basics {
  id
  field_basics_header {
    processed
  }

                                    ...
                                    {medicalProduct.length > 0 ? medicalProduct.map((data, index) => {
                                        ...
                                        return (
                                            <ProductCard
                                                ...
                                                productimage={data.relationships.field_medical_image && data.relationships.field_medical_image[0].localFile ? data.relationships.field_medical_image[0].localFile.childImageSharp.gatsbyImageData : ""}

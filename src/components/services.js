          ...
          return (
            <div className={(index == 0 || index % 2 == 0) && array.length % 2 ? "col-12 col-md-6 col-lg-5 offset-lg-1 " + servicesStyles.columnWrapper : (index == 0 || index % 2 == 0) ? "col-12 col-md-6 col-lg-5 offset-lg-1 " + servicesStyles.columnWrapper : "col-12 col-md-6 col-lg-5 " + servicesStyles.columnOddWrapper}>
              <div className={servicesStyles.cardWrapper}>
                ...
                {item.relationships.field_service_image ? item.relationships.field_service_image.localFile ? <div className={index == 2 || index == 3 ? servicesStyles.image + ' services-image ' + servicesStyles.specialImage : servicesStyles.image + " services-image"}><Img alt="img" fluid={item.relationships.field_service_image ? item.relationships.field_service_image.localFile ? item.relationships.field_service_image.localFile.childImageSharp.fluid : "" : ""} /></div> : '' : ""}

                            ...
                            return (
                                <div className={index == 0 || index % 2 == 0? "col-12 col-md-6 col-lg-5 offset-lg-1 " +  servicesStyles.columnWrapper: "col-12 col-md-6 col-lg-5 " +  servicesStyles.columnWrapper}>
                                    <div className={servicesStyles.cardWrapper}>
                                        ...
                                        {item.relationships.field_service_image.localFile ? <div className={index == 2 || index == 3 ? servicesStyles.image + ' ' + servicesStyles.specialImage : servicesStyles.image}><Img fluid={item.relationships.field_service_image.localFile.childImageSharp.fluid} /></div> : ''}

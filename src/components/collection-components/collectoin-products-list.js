...
fixe            {pageNodeType||node.relationships.field_vocabularies[0]?pageNodeType.toLowerCase().includes('medical')||node.relationships.field_vocabularies[0].__typename.toLowerCase().includes('medical')?

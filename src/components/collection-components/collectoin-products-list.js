...
const Collectionproducts = ({ node, nodetype, checktaxonomyType }) => {
  ...
  useEffect(() => {
    ...
    if (contentTileCol) {
      ...
      let ind = 1;
      if (allCol[0].classList.contains('col-lg-6') && allCol[1].classList.contains('col-lg-6')) { ind = 3 }
      else if (allCol[1].classList.contains('col-lg-6') && allCol[2].classList.contains('col-lg-6')) { ind = 3 }
      else if (allCol[0].classList.contains('col-lg-6') || allCol[1].classList.contains('col-lg-6')) { ind = 4 }
      else if (!allCol[0].classList.contains('col-lg-6') && !allCol[1].classList.contains('col-lg-6') && !allCol[2].classList.contains('col-lg-6') && !allCol[3].classList.contains('col-lg-6')) { ind = 5 }

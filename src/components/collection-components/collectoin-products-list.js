                ...
                <div id="contentTile" className={`col-12 col-lg-3 col-md-4 content-tile product-element ${productsliststyle.productview}`}>
                  <ContentTile
                    image={contentTile.relationships.field_tile_image
                      ...
                      && contentTile.relationships.field_tile_image.localFile.childImageSharp.gatsbyImageData ?
                      contentTile.relationships.field_tile_image.localFile.childImageSharp.gatsbyImageData : ""}
                        ...
                        <ProductCard
                          ...
                          productimage={
                            (product.relationships.field_clinical_image[0] && product.relationships.field_clinical_image[0].localFile)
                              ? product.relationships.field_clinical_image[0].localFile.childImageSharp.gatsbyImageData
                              : ""
                          }
...
export const fragment = graphql`fragment collectionproducts on taxonomy_term__clinical_skin_concern {
  relationships {
    node__clinical_product {
      field_clinical_id

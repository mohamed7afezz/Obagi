...
const CareersHero = ({ node }) => {
    return (
        <div>
            ...
            <div style={{ backgroundImage: `url(${node.relationships.field_background_image.localFile.childImageSharp.original.src})` }} className="d-none d-lg-block">
                <div className="container-fluid">
                    <div className="row">
                        ...
                        <div className="col-lg-5 offset-lg-1 p-0">
                            {node.relationships.field_careers_image ? <div className={careersHeroStyles.imageWrapper}><Img fluid={node.relationships.field_careers_image.localFile.childImageSharp.fluid} className={careersHeroStyles.image}/></div> : ''}
                        </div>
                    </div>
                </div>
            </div>

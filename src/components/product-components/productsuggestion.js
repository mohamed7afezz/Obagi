        ...
        <div className={productsuggestion.slickcon}>
          <Slider {...settings}>
            <div className={["col-12", productsuggestion.allcon].join(" ")}>
              <ProductCard
                producttitle="Lorem ipsum dolor sit amet consectetur adipiscing elit duis at pretium dolor "
                productdescription={{
                  __html:
                    "Aliquam eleifend feugiat nulla. In tristique elementum nisi, eget bibendum urna congue viverra",
                }}
                productimage={data.cardimg.childImageSharp.fluid}
                price="60"
                rate="5.0"
              />
            </div>

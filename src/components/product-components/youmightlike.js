             ...
             node.relationships.field_product_card.map((item, index) => (
               <div className={["col-12", productsuggestion.allcon].join(" ")}>
                 ...
                 productCat="clinical"
                   ...
                   productimage={item.relationships.field_clinical_image && item.relationships.field_clinical_image[0].localFile?item.relationships.field_clinical_image[0].localFile.childImageSharp.gatsbyImageData:''}
...
export const fragment = graphql`fragment youMightAlsoLikeParagrapgh on paragraph__you_might_also_like {
  id
  parent_field_name

    ...
    <div id="phys-finder">
        ...
        <form id="phys-finder-form">
            <div id="phys-finder-search-form">
                ...
                <p class="finder-subtitle text-center">Use this interactive physician finder to request a skin care
                    consultation with a professional in your area. A certified skin care advisor will consult with you
                    to develop a completely personalized Obagi skin care regimen. </p>

                <p class="finder-subtitle text-center" style={{ lineHeight : "normal;"}}>When you contact a physician, a free
                    deluxe sample of ELASTIderm Facial Serum will be shipped to you.</p>
                ...
                <div class="header">
                    <div class="controls">
                        ...
                        <div class="i-b submit-wrapper"><input onClick={(e) => { inputSubmit(e) }} id="pf-submit" type="submit" value="Update Search"/></div>
                    </div>
                </div>
            </div>
            ...
            <div class="count map-header">
                <div class="clearfix">
                    ...
                    <div id="pf-email-print" class="hide"><a href="#" target="_top" id="email-link"><img
                                src="/modules/custom/obagi_finder/images/email.png" style = {{width: "20px;"}} /> Email</a><a
                            href="javascript:window.print();" id="print-link"><img
                                src="/modules/custom/obagi_finder/images/printer.png" style = {{width: "20px;"}}  /> Print</a>
                    </div>
                </div>
            </div>
